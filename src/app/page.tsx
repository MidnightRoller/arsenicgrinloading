      ...
      <section className="relative h-screen flex items-center justify-center">
        <div className="absolute inset-0 overflow-hidden">
          <video 
            ...
            src="/videos/arsenic-bg-loop.mp4" // Replace with your video
          />
        </div>
...
/>
        ...
        <div className="space-y-6">
          ...
          <div className="mt-12 space-x-4">
            <Link 
              href="/music" 
              className="px-8 py-3 border-2 border-white text-white hover:bg-red-900/50 transition-all text-lg font-bold"
            >
              JOIN THE MAILING LIST
            </Link>
            <Link 
              href="/shows" 
              className="px-8 py-3 bg-red-900 hover:bg-red-800 transition-all text-lg font-bold"
            >
              SEE US LIVE
            </Link>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
              <div className="col-span-1">
                <div className="aspect-square bg-gray-800 rounded-lg overflow-hidden">
                  ...
                  <div className="w-full h-full flex items-center justify-center text-2xl">
                    <Image src="/images/album-art-placeholder.png" alt="Album Art" width={300} height={300} className="object-cover" />
                  </div>
                </div>
              </div>
              <div className="col-span-2">
                ...
                <div className="space-y-4">
                  <button className="w-full md:w-auto px-6 py-3 bg-red-900 hover:bg-red-800 transition-all font-bold">
                    STREAM NOW
                  </button>
                  <button className="w-full md:w-auto px-6 py-3 border border-red-900 hover:bg-red-900/20 transition-all font-bold ml-0 md:ml-4">
                    BUY DIGITAL
                  </button>
                </div>
              </div>
